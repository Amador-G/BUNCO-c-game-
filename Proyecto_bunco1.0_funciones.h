...
void LanzamientoDeDadosManual(int v[],int tam);//carga los dados manualmente.
...
void Partida1Jugador(int v);//ejecucion de ronda completa de un jugador.
...
void FinDePartida1Jugador (char NombreJugador[], int UnJugador[], int tam, int PuntajeFinal);//cartel finald e partida
